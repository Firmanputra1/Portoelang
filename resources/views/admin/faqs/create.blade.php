...
<div class="animate-on-scroll animated">
    <div style="margin-bottom: 32px;">
        ...
        <h2 style="font-family: 'Space Grotesk', sans-serif; font-size: 32px; font-weight: 700; color: var(--text-primary);">
            Tambah <span class="gradient-text">FAQ Baru</span>
        </h2>
        <p style="color: var(--text-secondary); margin-top: 4px;">Isi tanya jawab berikut untuk mempermudah informasi pengunjung.</p>
    </div>
    ...
    <div class="contact-form-card" style="max-width: 800px;">
        <form action="{{ route('admin.faqs.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="question" id="question" class="form-control" value="{{ old('question') }}" placeholder="Contoh: Berapa lama pengerjaan desain logo?" required>
                @error('question')
            ...
            <div class="form-group">
                ...
                <textarea name="answer" id="answer" class="form-control" placeholder="Tuliskan jawaban lengkap atas pertanyaan di atas..." style="min-height: 150px;" required>{{ old('answer') }}</textarea>
                @error('answer')
                    <span style="color: #ef4444; font-size: 13px; margin-top: 6px; display: block;">{{ $message }}</span>
                @enderror
            </div>
