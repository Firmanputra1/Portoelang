    ...
    <form action="{{ route('admin.clients.update', $client) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <div style="margin-top: 8px;">
                <img src="{{ asset('storage/' . $client->logo) }}" alt="Logo Preview" style="max-width: 150px; max-height: 60px; object-fit: contain; background: rgba(255,255,255,0.02); padding: 6px; border-radius: 6px; border: 1px solid var(--border);">
            </div>
        </div>
        @endif
