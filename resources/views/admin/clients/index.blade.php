        ...
        <table>
            ...
            <tbody>
                ...
                <tr class="table-row-element" data-name="{{ strtolower($client->name) }}">
                    <td>
                        @if($client->logo)
                            <img src="{{ asset('storage/' . $client->logo) }}" alt="{{ $client->name }}" style="max-width: 100px; max-height: 40px; object-fit: contain; background: rgba(255,255,255,0.02); padding: 4px; border-radius: 4px; border: 1px solid var(--border);">
                        @else
