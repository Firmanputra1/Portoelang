    ...
    */
    ...
    'disks' => [
        ...
        's3' => [
            ...
            'use_path_style_endpoint' => env('SUPABASE_USE_PATH_STYLE_ENDPOINT', env('AWS_USE_PATH_STYLE_ENDPOINT', false)) === 'true' || env('SUPABASE_USE_PATH_STYLE_ENDPOINT', env('AWS_USE_PATH_STYLE_ENDPOINT', false)) === true,
            'throw' => true,
            'report' => false,
        ],
